<template>
  <router-link :to="{name : 'advert', params: {advert_id: ad.id}}" class="list-group-item list-group-item-action">
    ...
    <small>Posted by <strong><a href="#">{{ ad.owner }}</a></strong> on {{ad.timestamp}}</small>
  </router-link>
</template>
